# Generated by Powerlevel10k configuration wizard on 2020-05-21 at 22:34 CEST.
# Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 00682.
# Wizard options: nerdfont-complete + powerline, large icons, pure, snazzy, rpromt,
# 24h time, 2 lines, sparse, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    anaconda                  # virtualenv from anaconda
